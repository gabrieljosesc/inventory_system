    ...
    <div className="app-layout">
      <nav className="app-nav">
        ...
        <ul>
          ...
          <li><NavLink to="/reorder" className={({ isActive }) => (isActive ? 'active' : '')}>Reorder</NavLink></li>
          <li><NavLink to="/movements" className={({ isActive }) => (isActive ? 'active' : '')}>Movements</NavLink></li>
          {user?.role === 'admin' && (
        ...
        <div className="app-nav-account">
          ...
          <ul>
            <li><NavLink to="/change-password" className={({ isActive }) => (isActive ? 'active' : '')}>Change password</NavLink></li>
          </ul>
